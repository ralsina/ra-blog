...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon8 = QtGui.QIcon()
        icon8.addFile(":/icons/icons/camera.svg")
        self.actionFlickr_Image.setIcon(icon8)
        self.actionFlickr_Image.setObjectName("actionFlickr_Image")
        self.actionOpenomy_File = QtGui.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addFile(":/icons/icons/openomy.svg")
        self.actionOpenomy_File.setIcon(icon9)
        self.actionOpenomy_File.setObjectName("actionOpenomy_File")
        self.actionSave = QtGui.QAction(MainWindow)
        icon10 = QtGui.QIcon()
        icon10.addFile(":/icons/icons/filesave.svg")
        self.actionSave.setIcon(icon10)
        self.actionSave.setObjectName("actionSave")
        self.actionClose = QtGui.QAction(MainWindow)
        icon11 = QtGui.QIcon()
        icon11.addFile(":/icons/icons/fileclose.svg")
        ...
        icon12 = QtGui.QIcon()
        icon12.addFile(":/icons/icons/fonts.svg")
        self.actionRST.setIcon(icon12)
        self.actionRST.setObjectName("actionRST")
        self.actionFind = QtGui.QAction(MainWindow)
        icon13 = QtGui.QIcon()
        icon13.addFile(":/icons/icons/find.svg")
        self.actionFind.setIcon(icon13)
        self.actionFind.setObjectName("actionFind")
        self.actionFindNext = QtGui.QAction(MainWindow)
        icon14 = QtGui.QIcon()
        icon14.addFile(":/icons/icons/next.svg")
        self.actionFindNext.setIcon(icon14)
