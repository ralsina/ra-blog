...
#
# Created: Fri Feb  6 13:17:22 2009
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menu_File.setGeometry(QtCore.QRect(0, 0, 100, 148))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons/webexport.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRender_Blog.setIcon(icon1)
        self.actionRender_Blog.setObjectName("actionRender_Blog")
        self.actionNewPost = QtGui.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/icons/filenew.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNewPost.setIcon(icon2)
        self.actionNewPost.setObjectName("actionNewPost")
        self.actionConfigure = QtGui.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/icons/configure.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionRender_Full_Blog.setIcon(icon1)
        ...
        self.actionNew_Story.setIcon(icon2)
        self.actionNew_Story.setObjectName("actionNew_Story")
        self.actionQuit = QtGui.QAction(MainWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/icons/exit.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionQuit.setIcon(icon5)
        self.actionQuit.setObjectName("actionQuit")
        self.actionBartleBlog_Help = QtGui.QAction(MainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/icons/help.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBartleBlog_Help.setIcon(icon6)
